...
_TEXTS: dict[str, dict[str, str]] = {
    ...
    "menu.not_interesting": {UI_RU: "🙈 Не интересно", UI_EN: "🙈 Not Interested"},
    "menu.track_again": {UI_RU: "👀 Убрать из не интересно", UI_EN: "👀 Remove from Not Interested"},
    ...
    "menu.notification_details": {UI_RU: "🔔 Уведомления о квалах и практиках", UI_EN: "🔔 Qualifying and Practice Alerts"},
    "menu.enable_all_qualifying": {UI_RU: "✅ Все квалы", UI_EN: "✅ All Qualifying"},
    "menu.disable_all_qualifying": {UI_RU: "❌ Все квалы", UI_EN: "❌ All Qualifying"},
    "menu.enable_all_practice": {UI_RU: "✅ Все практики", UI_EN: "✅ All Practice"},
    "menu.disable_all_practice": {UI_RU: "❌ Все практики", UI_EN: "❌ All Practice"},
    "menu.all_qualifying": {UI_RU: "Все квалы", UI_EN: "All Qualifying"},
    "menu.all_practice": {UI_RU: "Все практики", UI_EN: "All Practice"},
    ...
    "onboarding.enter_timezone": {
        UI_RU: "Введите ваш часовой пояс, например: <code>Europe/Berlin</code> или просто <code>Samara</code>",
        UI_EN: "Enter your timezone, for example: <code>Europe/Berlin</code> or simply <code>Samara</code>",
    },
    ...
    "help.body": {
        UI_RU: "1. Начните с <b>Подписок</b>: выберите серии, классы или СМП РСКГ. Именно подписки определяют, какие гонки попадут в ваши экраны и уведомления.\n2. <b>Сегодня</b> показывает ближайшие сессии по вашим подпискам, а <b>Неделя</b> собирает весь гоночный уикенд целиком.\n3. В <b>Профиле</b> настраиваются язык интерфейса, часовой пояс, языки трансляций, дайджест и общие типы уведомлений.\n4. В разделе <b>Уведомления о квалах и практиках</b> можно отдельно включать и выключать уведомления по квалам и практикам. Сверху есть массовые переключатели для всех подписок.\n5. В уведомлениях сразу показываются live timing, если они доступны. Кнопка <b>Избранное</b> сохраняет уикенд, чтобы потом было проще его найти.\n6. Кнопка <b>Не интересно</b> отключает уведомления только по этому уикенду до конца события. Сам уикенд из расписания при этом не пропадает.\n7. Разделы <b>Избранное</b> и <b>Не интересно</b> работают на уровне всего уикенда, а не одной отдельной сессии.\n8. <b>Поиск</b> помогает быстро найти серию или класс, а <b>База знаний</b> объясняет термины и чемпионаты.\n9. Фильтр языков влияет только на список трансляций. Если трансляции на выбранных языках нет, сама гонка всё равно останется в расписании.",
        UI_EN: "1. Start with <b>Subscriptions</b>: choose series, classes, or SMP RSKG. Your subscriptions define which races appear in your screens and notifications.\n2. <b>Today</b> shows the nearest sessions from your subscriptions, while <b>Week</b> collects the full race weekend.\n3. In <b>Profile</b>, you can configure the interface language, timezone, broadcast languages, digest, and global notification types.\n4. In <b>Qualifying and Practice Alerts</b>, you can turn qualifying and practice notifications on or off separately. Bulk switches for all subscriptions are available at the top.\n5. Notifications include live timing right away when available. <b>Favorite</b> saves the weekend so it is easier to find later.\n6. <b>Not Interested</b> mutes notifications only for that weekend until the event ends. The weekend itself still stays in the schedule.\n7. <b>Favorites</b> and <b>Not Interested</b> work at weekend level, not single-session level.\n8. <b>Search</b> helps you quickly find a series or class, and the <b>Knowledge Base</b> explains racing terms and championships.\n9. Broadcast language filters affect only the list of broadcasts. If no matching broadcast is found, the race still remains in your schedule.",
    },
    "profile.summary": {
    ...
    "profile.ambiguous_timezone": {UI_RU: "Найдено несколько подходящих часовых поясов. Выберите нужный:", UI_EN: "Multiple matching timezones found. Choose one:"},
    ...
    "subscriptions.notify_title": {
        UI_RU: "🔔 <b>Уведомления о квалах и практиках</b>\nСверху есть массовые переключатели, ниже точечная настройка по подпискам.",
        UI_EN: "🔔 <b>Qualifying and Practice Alerts</b>\nUse the bulk switches at the top or fine-tune subscriptions below.",
    },
    ...
    "favorites.empty": {UI_RU: "❤️ <b>Избранное</b>\n\nПока пусто. Добавляйте интересные гоночные уикенды из уведомлений или карточек сессий.", UI_EN: "❤️ <b>Favorites</b>\n\nNothing here yet. Add interesting race weekends from notifications or session cards."},
    "favorites.title": {
        UI_RU: "❤️ <b>Избранные уикенды</b>\n\nЗдесь хранятся уикенды, которые вы сохранили, чтобы их было проще найти.",
        UI_EN: "❤️ <b>Favorite Weekends</b>\n\nSaved weekends appear here so they are easier to find later.",
    },
    ...
    "session.favorite_removed": {UI_RU: "💔 Уикенд убран из избранного", UI_EN: "💔 Weekend removed from favorites"},
    "ignored.empty": {UI_RU: "🙈 <b>Не интересно</b>\n\nЗдесь будут гонки и уикенды, по которым вы отключили уведомления.", UI_EN: "🙈 <b>Not Interested</b>\n\nRace weekends with muted notifications will appear here."},
    "ignored.title": {
        UI_RU: "🙈 <b>Не интересно</b>\n\nЗдесь хранятся уикенды, по которым вы отключили уведомления до конца события.",
        UI_EN: "🙈 <b>Not Interested</b>\n\nWeekends with muted notifications until the event ends appear here.",
    },
    "ignored.added": {
        UI_RU: "🙈 Добавлено в не интересно",
        UI_EN: "🙈 Added to Not Interested",
    },
    "ignored.removed": {UI_RU: "👀 Уикенд убран из не интересно", UI_EN: "👀 Weekend removed from Not Interested"},
    "event.not_found": {UI_RU: "Гоночный уикенд не найден", UI_EN: "Race weekend not found"},
